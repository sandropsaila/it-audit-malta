...
const JOBS = [
  ...
  },
  {
    ...
    type: "Full-time",
    salary: null,
    posted: "c. 30 Aug 2026",
    description:
      "Internal Audit Manager vacancy at PLAY NORTH, spotted on LinkedIn. Open the listing for full responsibilities and requirements.",
    skills: ["Internal Audit", "iGaming", "Management"],
    source: "LinkedIn",
    url: "https://www.linkedin.com/jobs/search/?keywords=Internal+Audit+Manager+PLAY+NORTH&location=Malta",
    added: "2026-09-20",
  },
  {
    category: "Internal Audit",
    title: "Internal Audit Officer",
    company: "Lombard Bank Malta plc",
    location: "Valletta, Malta",
    type: "Full-time",
    salary: null,
    posted: "c. Jul 2026",
    description:
      "Internal Audit Officer vacancy at Lombard Bank Malta plc, spotted on LinkedIn (listed about 2 months ago, so confirm it is still open).",
    skills: ["Internal Audit", "Banking", "Financial Services"],
    source: "LinkedIn",
    url: "https://www.linkedin.com/jobs/search/?keywords=Internal+Audit+Officer+Lombard+Bank+Malta+plc&location=Malta",
    added: "2026-09-20",
  },
  {
    category: "GRC & ISO",
    title: "ICT Governance & Resilience Manager",
  ...
  {
    category: "GRC & ISO",
    title: "Technical Compliance Manager - Italy",
    company: "Betsson Group",
    location: "Sliema, Malta (Hybrid)",
    type: "Full-time",
    salary: null,
    posted: "c. 17 Sep 2026",
    description:
  ...
  },
  {
    ...
    type: "Full-time",
    salary: null,
    posted: "c. 18 Sep 2026",
    description:
      "Governance, Risk and Compliance Manager vacancy advertised via ACCA Careers, spotted on LinkedIn. Open the listing for full responsibilities and requirements.",
  ...
  },
  {
    ...
    posted: "27 Aug 2026",
    description:
      "Audit Manager in the EY Malta Assurance Department, delivering audit and advisory services to a portfolio of clients. Posted on EY's careers site on 27 Aug 2026 (requisition 1721942).",
    skills: ["External Audit", "Assurance", "Management", "EY"],
    source: "EY Careers",
...
export default function App() {
  ...
  const LIVE_LINKS = [
    ...
    { name: "LinkedIn – Auditor Malta",          url: "https://mt.linkedin.com/jobs/auditor-jobs" },
    // ── Recruitment Agencies ──
    { name: "GRS Recruitment",                   url: "https://jobs.grsrecruitment.com" },
    { name: "Konnekt",                           url: "https://konnekt.com/jobs" },
    { name: "Broadwing",                         url: "https://broadwing.jobs" },
    { name: "Reed Malta",                        url: "https://reedglobal.com.mt" },
    { name: "Manpower Malta",                    url: "https://manpowergroup.com.mt" },
    { name: "Outreach Recruitment",              url: "https://outreachrecruitment.net" },
    { name: "AIMS International Malta",          url: "https://aims-malta.com" },
    { name: "Heroix",                            url: "https://heroix.com.mt" },
    { name: "Accelerate",                        url: "https://accelerate.mt" },
    { name: "Castille Resources",                url: "https://castilleresources.com" },
    { name: "Boston Link",                       url: "https://boston-link.com" },
    { name: "Link Talent",                       url: "https://linktalent.careers" },
    { name: "Van Kaizen",                        url: "https://vankaizen.com" },
    { name: "Archer IT",                         url: "https://archer.mt" },
    { name: "Pentasia",                          url: "https://pentasia.com" },
    { name: "Cross Border Talents",              url: "https://crossbordertalents.com" },
    { name: "Ceek Talent",                       url: "https://ceektalent.com" },
    { name: "M Recruitment",                     url: "https://mrecruitment.eu" },
    // ── Malta Job Boards ──
    ...
    { name: "Muovo",                             url: "https://muovo.eu" },
    { name: "Careerjet Malta",                   url: "https://www.careerjet.com.mt" },
    { name: "Findajob.mt",                       url: "https://findajob.mt" },
    { name: "Jobsplus",                          url: "https://jobsplus.gov.mt/job-seekers-mt-en-gb/find-a-job" },
    // ── Professional Bodies ──
    { name: "ACCA Careers – Malta",              url: "https://jobs.accaglobal.com/jobs/malta/audit/" },
    ...
    { name: "PwC Malta Careers",                 url: "https://www.pwc.com/mt/en/careers.html" },
    // ── Malta News (vacancy announcements) ──
    { name: "Times of Malta – Business",         url: "https://timesofmalta.com/business" },
    { name: "MaltaToday – Business",             url: "https://maltatoday.com.mt/business" },
    { name: "The Business Picture",              url: "https://thebusinesspicture.com" },
    { name: "Malta Independent – Business",      url: "https://independent.com.mt/business" },
  ];
